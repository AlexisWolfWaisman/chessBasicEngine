...
spot_movement = lambda initialPos,distance:  set(spider_movement(initialPos,distance)) - set(map(tuple,NParray(initialPos) + list(prodCartesiano((2,-2),repeat=2))))
...
positive_pawn_movement = lambda initialPos: None
